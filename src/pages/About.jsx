        ...
        <section className={`${toggle ? ' text-white' : 'bg-white text-black'}  py-16`}>
            ...
            <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="md:w-1/2 space-y-6 text-center md:text-left">
                    ...
                    <p data-aos="fade-up"  className={`${toggle ? 'text-gray-300 ' : ' text-black' } text-lg`}>
                    ...
                    <ul data-aos="fade-up" className={`list-disc list-inside ${toggle ? 'text-gray-300 ' : ' text-black' } space-y-2`}>
