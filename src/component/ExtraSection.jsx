    ...
    return (
        <section data-aos="fade-up" className={`${toggle ?   'bg-white text-black':'bg - indigo - 50'}  py-16`}>
            <div className="max-w-6xl mx-auto px-4 text-center">
                ...
                {/* Section Title */}
                <h2 data-aos="fade-up" className="text-4xl font-extrabold text-indigo-600 mb-4">
                    Why Join ContestHub?
                </h2>
                <p data-aos="fade-up" className={`${toggle ? 'text-gray-600' : 'text-gray-300'} mb-12 max-w-3xl mx-auto`}>
