    ...
    return (
        <section data-aos="fade-up" className={`  pb-16`}>
            <div className="max-w-6xl mx-auto px-4 text-center">
                ...
                {/* Section Title */}
                <h2 data-aos="fade-up" className="text-4xl font-extrabold text-white mb-2">
                    Why Join ContestHub?
                </h2>
                <p data-aos="fade-up" className={` mb-12 text-[20px] text-gray-300 max-w-3xl mx-auto`}>
                ...
                <div data-aos="fade-up" className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        <h3 className="text-2xl font-bold text-indigo-600 mb-2">Creative Contests</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        <h3 className="text-2xl font-bold text-indigo-600 mb-2">Win Exciting Prizes</h3>
                        <p className="text-gray-600 ">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        <h3 className="text-2xl font-bold text-indigo-600 mb-2">Connect & Learn</h3>
                        <p className="text-gray-600">
