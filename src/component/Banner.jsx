...
const Banner = () => {
    return (
        <div data-aos="fade-up" className="relative w-full h-[70vh] md:h-[80vh]  overflow-hidden">
            ...
            <div data-aos="fade-up" className="relative z-10 w-11/12 mx-auto h-full flex flex-col justify-center text-center text-white">
                ...
                <h1 data-aos="fade-up" className="text-3xl md:text-5xl font-extrabold leading-tight drop-shadow-md">
                    Discover & Join The Best <br /> Creative Contests
                </h1>

                <p data-aos="fade-up" className="mt-4 text-sm md:text-lg opacity-90">
                    Explore thousands of design, article writing, idea pitching & more contests.
                </p>

                {/* Search Bar */}
                <div data-aos="fade-up" className="mt-8 flex items-center justify-center">
                    <div data-aos="fade-up" className="w-full md:w-2/3 lg:w-1/2 flex gap-2">
                        ...
                        />
                        <button data-aos="fade-up" className="btn bg-[#2563EB] hover:bg-[#1D4ED8] text-white rounded-xl px-6 font-semibold">
                            Search
                        </button>
                    </div>
                </div>
